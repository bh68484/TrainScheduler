$(document).ready(function() {
  ...
  $("#submit").on("click", function() {
    ...
    var frequency = $("#frequency")
      .val()
      .trim();
    //Pushes the form information to firebase
    database.ref().push({
      name: name,
    ...
    //Resets the form after user submits a new train
    $("form").trigger("reset");
  });
  ...
  database.ref().on(
    ...
    function(childSnapshot) {
      ...
      //Dynamically creates the table based on the information that the user submitted
      //Next Arrival and Minutes Away are calculated using moments.js
